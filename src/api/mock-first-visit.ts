...
const mockAppointments: MockAppointmentRecord[] = [
  ...
  {
    id: 9007,
    appointmentNo: 'FV20260608001',
    studentId: 7007,
    studentNo: '2023001007',
    studentName: '林悦晨',
    college: '文学院',
    phone: '13900000017',
    mainProblem: '学习动力不足，注意力难以集中',
    problemDescription: '近期上课无法集中注意力，作业拖延严重，对学习失去兴趣。',
    expectedHelp: '希望找到提升学习动力的方法。',
    moodScore: 6,
    sleepScore: 5,
    stressScore: 7,
    selfHarmFlag: 0,
    ...
    priorityFlag: 0,
    auditRemark: '请按时参加初访。',
    auditTime: '2026-06-08 09:00',
    auditorName: '中心管理员',
    createTime: '2026-06-08 08:30',
  },
  {
    id: 9008,
    appointmentNo: 'FV20260608002',
    studentId: 7008,
    studentNo: '2023001008',
    studentName: '陈思远',
    college: '物理学院',
    phone: '13900000018',
    mainProblem: '科研压力大，导师关系紧张',
    problemDescription: '近期科研进展不顺，与导师沟通存在障碍，感到焦虑和无助。',
    expectedHelp: '希望获得压力管理和沟通技巧方面的建议。',
    moodScore: 7,
    sleepScore: 6,
    stressScore: 8,
    selfHarmFlag: 0,
    ...
    appointmentStatus: 'APPROVED',
    priorityFlag: 1,
    auditRemark: '高风险学生，请优先安排。',
    auditTime: '2026-06-08 10:15',
    auditorName: '中心管理员',
    createTime: '2026-06-08 09:45',
  },
  {
    id: 9009,
    appointmentNo: 'FV20260608003',
    studentId: 7009,
    studentNo: '2023001009',
    studentName: '张雨萱',
    college: '艺术学院',
    phone: '13900000019',
    mainProblem: '人际关系困扰，社交焦虑',
    problemDescription: '在集体活动中感到紧张，害怕被评价，回避社交场合。',
    expectedHelp: '希望学习社交技巧，减轻焦虑感。',
    moodScore: 5,
    sleepScore: 4,
    stressScore: 6,
    selfHarmFlag: 0,
